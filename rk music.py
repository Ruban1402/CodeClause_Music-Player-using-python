...
playB = tkinter.Button(player,width=7,height=1,font="Helvetica",text="Attune",command=play,bg="lightgreen").grid(row=2,column=0)
pauseB = tkinter.Button(player, width=7, height=1, font="Helvetica", text="Halt", command=pause, bg="lightblue", fg="black").grid(row=2,column=1)
resumeB = tkinter.Button(player, width=9, height=1, font="Helvetica", text="Continue Playback", command=resume, bg="lightpink", fg="black").grid(row=2,column=2)
player.mainloop()